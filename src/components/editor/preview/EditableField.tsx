...
export const EditableField: React.FC<EditableFieldProps> = ({
  ...
  // Tracks when user is pressing down on the toolbar, which prevents blur from closing it
  const toolbarDown = useRef(false);

  // Sync content from store whenever we're not editing; sanitize on the read path to block stored XSS
  useEffect(() => {
