/**
 * Replaces the browser's beforeunload popup. Render <UnsavedModal /> once inside
 * EditorPage, then `await useUnsavedGuard().guardAsync()` before navigating away.
 * It resolves true if the user chose to continue.
 */
