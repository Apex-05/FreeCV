...
- Open a report through the repository's **Security** tab
  (**Report a vulnerability** creates a private thread only maintainers can see),
  or
- Use GitHub's **Report abuse** option on the comment, issue, or pull request in
  question, which escalates directly to GitHub Support.
